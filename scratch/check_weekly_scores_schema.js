...
async function main() {
  const res = await fetch(`${BASE_URL}/weekly_scores?limit=1`, {
    headers: {
      'apikey': ANON_KEY,
  ...
  console.log('weekly_scores sample row keys:', Object.keys(data[0] || {}));
  console.log('weekly_scores sample row:', data[0]);
}
main();
